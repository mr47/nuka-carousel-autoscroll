...
exports.NukaDecorate = exports.ProgressIcon = exports.AutoScrollDecorator = undefined;
...
var _autoScrollProgress = require('./autoScrollProgress');

var _autoScrollProgress2 = _interopRequireDefault(_autoScrollProgress);
...
/*
*
* Internal its using react context api. Its using 2 seperated timers for
*
* */
function NukaDecorate() {
    var options = arguments.length <= 0 || arguments[0] === undefined ? { duration: 5000, maxTickCount: 10, decorators: [_bullet2.default] } : arguments[0];
                ...
                value: function render() {
                    ...
                    return _react2.default.createElement(
                        ...
                        _extends({ ref: function ref(_ref) {
                            ...
                            }, decorators: [].concat(_toConsumableArray(options.decorators), [(0, _autoScrollBase2.default)(options)(_autoScrollProgress2.default)]) }, this.props),
                        children
                    );
                }
            }]);
...
exports.ProgressIcon = _autoScrollProgress2.default;
